...
dist = [ 1 0 0 0 0 0 0 0 zeros(1,20)];
...
%Tipo da falha: 
    % -1 para estacionaria
    % 0 para falha fecha
    % 25 para falha 25% abertura
    % 50 para falha 50% abertura
    % 75 para falha 75% abertura
    % 100 para falha fecha
